...
MODULE_MAP = {
    ...
    'PIL':          ('Pillow',       'image processing library',             False),
    'cv2':          ('opencv-python','computer vision library',              False),
    'numpy':        ('numpy',        'numerical computing library',          False),
    'pandas':       ('pandas',       'data analysis library',                False),
    'matplotlib':   ('matplotlib',   'data visualization library',           False),
    'requests':     ('requests',     'HTTP requests library',                False),
    'pygame':       ('pygame',       'game development library',             False),
    'sqlite3':      ('sqlite3',      'lightweight database',                 True),
    ...
    'qrcode':       ('qrcode',       'QR code generator',                   False),
    'barcode':      ('python-barcode','barcode generator',                  False),
}
